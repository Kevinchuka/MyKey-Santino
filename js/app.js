...
const textos = {
  en: {
    ...
    showcase: {
      ...
      descripcion:
        'Contextual visuals powered by keywords (gaming, support, payments) so every story looks aligned with the experience.',
  ...
  es: {
    ...
    showcase: {
      ...
      descripcion:
        'Visuales contextuales usando keywords (gaming, soporte, pagos) para que cada historia se vea alineada a la experiencia.',
